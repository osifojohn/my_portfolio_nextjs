export const projects = [
  ...
  // },
  {
    title: 'SabiGuard (crowd safety and incident reporting platform)',
    description:
      'SabiGuard is an online platform that I developed to enhance public safety and foster community engagement in Nigeria. The platform delivers real-time incident notifications, optimizes emergency response times, and encourages active community participation in safety efforts',
    image: './images/sabi-home.png',
    tags: [
      'ReactJs',
      'NextJs',
      'TypeScript',
    ...
    source: 'https://sabiguard-ui.vercel.app/',
    visit:
      'https://www.linkedin.com/posts/osifo-john-bb44141b5_hey-everyone-exciting-news-im-thrilled-activity-7231578286466748416-3uMc?utm_source=share&utm_medium=member_desktop',
    id: 0,
  },
  {
